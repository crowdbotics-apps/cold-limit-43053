"""
Django settings for cold_limit_43053 project.
...
ROOT_URLCONF = 'cold_limit_43053.urls'
...
WSGI_APPLICATION = 'cold_limit_43053.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_limit_43053 API",
    "DESCRIPTION": "API documentation for cold_limit_43053 App",
    "VERSION": "v1",
}
